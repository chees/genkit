...
import { auth, GoogleAuth, GoogleAuthOptions, JWTInput } from 'google-auth-library';
import z from 'zod';
import {
...
export const vertexAI: Plugin<[PluginOptions] | []> = genkitPlugin(
  ...
  async (options?: PluginOptions) => {
    ...
    if (process.env.GCLOUD_SERVICE_ACCOUNT) {
      ...
      authOptions = { credentials: serviceAccountCreds, scopes: [CLOUD_PLATFROM_OAUTH_SCOPE] };
